...
import { useDataQuery, DataProvider } from '@dhis2/app-runtime';
import _JSXStyle from 'styled-jsx/style';
import PropTypes from 'prop-types';
import i18n from '@dhis2/d2-i18n';
import { Modal, InputField, Button, ScreenCover, CircularLoader } from '@dhis2/ui-core';
...
var replaceNewlinesWithBreaks = function replaceNewlinesWithBreaks(text) {
  return text.split('\n').reduce(function (out, line, i) {
    return [].concat(_toConsumableArray(out), [line, React.createElement("br", {
      key: i
    })]);
  }, []);
};
  ...
  _createClass(FatalErrorBoundary, [{
    ...
    value: function render() {
      ...
      if (this.state.error) {
        ...
        }, translatedErrorHeading, React.createElement("br", {
          className: "jsx-".concat(_defaultExport.__hash)
        }), i18n.t('The following information may be requested by technical support.')), React.createElement("div", {
...
var LoginModal = function LoginModal(_ref2) {
  ...
  var _useState = useState(staticUrl || window.localStorage.DHIS2_BASE_URL || ''),
  ...
  return React.createElement(Modal, {
    ...
    onSubmit: onSubmit
  }, React.createElement(Modal.Title, null, i18n.t('Please sign in')), React.createElement(Modal.Content, null, !staticUrl && React.createElement(InputField, {
...
var setGlobalLocale = function setGlobalLocale(locale) {
  if (locale !== 'en' && locale !== 'en-us') {
    import("moment/locale/".concat(locale)).catch(function () {
      /* ignore */
    });
  }
...
var AuthBoundary = function AuthBoundary(_ref) {
  ...
  var _useDataQuery = useDataQuery(settingsQuery),
  ...
  if (loading) {
    return React.createElement(ScreenCover, null, React.createElement(CircularLoader, null));
  }
...
var App = function App(_ref) {
  var url = _ref.url,
      ...
      children = _ref.children;
  return React.createElement(FatalErrorBoundary, null, React.createElement(DataProvider, {
    baseUrl: url,
    apiVersion: apiVersion
  }, React.createElement(HeaderBar, {
    appName: appName
  }), React.createElement(AuthBoundary, {
    url: url
  }, children)));
};
